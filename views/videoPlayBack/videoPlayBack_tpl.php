...
<html lang="ja">
   ...
   <body>
	...
	<div class="wrap mh_c btn_b_wrap">
		<h2>購入動画再生</h2>
		<section>
			<img class="movie" src="https://placehold.jp/500x300.png">
		</section>
		<button class="button btn_b btn_b_1" type="button" value="" onclick="location.href='#'"><span>購入済み動画一覧へ</span></button>
	</div>
	<footer id="footer">
	</footer>
</body>
