...
<html lang="ja">
    <head>
        ...
        <link rel="stylesheet" href="../../viewIncludeFiles/css/changePasswordMailComplete.css" />
	...
	<div class="wrap mh_c btn_b_wrap">  
		...
		<div class="content_wrap">
			...
			<section>
				<button class="button btn_b btn_b_1" type="submit" value="" onclick="location.href='#'"><span>トップへ</span></button>
			</section>
		</div>
	</div>
	<footer id="footer">
