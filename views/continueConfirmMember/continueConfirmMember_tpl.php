	...
	<div class="wrap mh_c btn_b_wrap">  
		...
		<div class="content_wrap">
			...
			<section class="btn_wrap">
				<button class="button btn_gray" type="submit" value="" onclick="location.href='#'"><span>内容を修正する</span></button>
				<button class="button" type="submit" value="" onclick="location.href='#'"><span>決済方法へ</span></button>
			</section>
		</div>
	</div>
	<footer id="footer">
