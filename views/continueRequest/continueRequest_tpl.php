	...
	<div class="wrap mh_c btn_b_wrap">  
		...
		<div class="content_wrap">
			<section>
				...
				<div class="bottom">
					<button class="button" type="button" value="" onclick="location.href='#'"><span>継続手続き</span></button>
				</div>
			</section>
			<button class="button btn_gray" type="button" value="" onclick="location.href='#'"><span>退会手続き</span></button>
		</div>
	</div>
	<footer id="footer">
	</footer>
