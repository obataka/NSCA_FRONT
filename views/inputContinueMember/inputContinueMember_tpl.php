...
<body>
	...
	<div class="wrap mh_c btn_b_wrap">
		...
		<div class="content_wrap">
			...
			<form action="../continueConfirmMember/continueConfirmMember_tpl.php" method="post" enctype="multipart/form-data" name="continueConfirmMemberForm">
					...
					<table>
						<tr class="kaiin">
							...
							<td>
								...
								<input id="kaiin_select_1" type="radio" name="kaiin_select" value="1">
								<label for="kaiin_select_1">NSCA正会員</label>
								<input id="kaiin_select_2" type="radio" name="kaiin_select" value="2">
								<label for="kaiin_select_2">学生会員</label><br>
								<ul class="error_ul">
									<li class="error" id="err_kaiin_select"></li>
								</ul>
					...
					<table>
						...
						<tr class="address">
							...
							<td>
								...
								<p class="mt_1">建物／部屋番号</p><input id="address_tatemono" class="w_80" type="text" name="address_tatemono" value="<?php echo $address_tatemono; ?>">
								<ul class="error_ul">
						...
						<tr class="job">
							...
							<td>
								<p><select id="job_1" class="w_70" type="text" name="" value="">
										<option value=""></option>
									</select></p>
								<p class="mt_1"><select id="job_2" class="w_70" type="text" name="" value="">
										<option value=""></option>
									</select></p>
								<p class="mt_1"><select id="job_3" class="w_70" type="text" name="" value="">
										<option value=""></option>
									</select></p>
							</td>
						</tr>
						...
						<tr class="address">
							...
							<td>
								<p>郵便番号</p><input id="office_yubin nb_1" class="yubin_1" type="text" name="office_yubin_nb_1" value="<?php echo $office_yubin_nb_1; ?>">-<input id="office_yubin_nb_2" class="yubin_2" type="text" name="office_yubin_nb_2" value="<?php echo $office_yubin_nb_2; ?>">
