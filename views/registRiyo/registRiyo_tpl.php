...
<head>
	...
	<link rel="stylesheet" href="../../viewIncludeFiles/css/nyukai_riyo.css">
...
<body>
	...
	<div class="wrap">
		...
		<div class="agreement_wrap bg_white">
			<div class="teikan">
		...
		<button id="next_button" class="button btn_center" type="submit" value=""><span>次へ</span></button>
	</div>
	<footer id="footer">
	</footer>
</body>
