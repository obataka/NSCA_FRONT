...
<head>
	...
	<script type="text/javascript" src="../../viewIncludeFiles/js/registRiyo.js"></script>

</head>

<body class="registRiyo">
	...
	<div class="wrap before_login">
		...
		<p class="top_text exclamation">18歳未満の方は、入会申込フォームからお申込みいただくことはできません。電話またはメールにて<a class="link_blank" href="https://www.nsca-japan.or.jp/06_qanda/top.html#contact" target="_blank">お問い合わせ<i class="fas fa-window-restore"></i></a>ください。</p>
		...
		<form action="../confirmRiyo/confirmRiyo_tpl.php" method="post">
					...
					<table class="form_table">
						<tbody>
							...
							<tr class="birthday">
								...
								<td>
									<p>西暦</p><input id="year" type="text" name="seireki_name" value="<?php echo $seireki_name; ?>">
									年
							...
							<tr class="address">
								...
								<td>
									<p>郵便番号</p>
									<input id="address_yubin_nb_1" class="yubin_1" type="text" name="address_yubin_nb_1" value="<?php echo $address_yubin_nb_1; ?>">-<input id="yubin_nb_2" class="yubin_2" type="text" name="yubin_nb_2" value="<?php echo $yubin_nb_2; ?>">
							...
							<tr class="mail">
								...
								<td>
									<p>メールアドレス1</p>
									<input id="mail_address_1" class="w_80" type="email" name="mail_address_1" value="<?php echo $mail_address_1; ?>"><br>
									<ul class="error_ul">
										<li class="error" id="err_mail_address_1"></li>
									</ul>
									<div class="mail_radio_wrap">
									...
									<p class="mt_1">メールアドレス2</p>
									<input id="mail_address_2" class="w_80" type="email" name="mail_address_2" value="<?php echo $mail_address_2; ?>"><br>
									<ul class="error_ul">
					...
					<table class="form_table">
						<tbody>
							<tr>
								...
								<td>
									<input id="hoho_1" type="radio" name="hoho" value="1">
									<label for="hoho_1">メールでお知らせ</label>
									<input id="hoho_2" type="radio" name="hoho" value="2">
									<label for="hoho_2">郵便でお知らせ</label>
									<ul class="error_ul">
										<li class="error" id="err_renraku_hoho"></li>
									</ul>
									<p class="kome">@nsca-japan.or.jpからのメールが届くよう受信設定をしてください。エラーで送れない場合、郵送となることがあります。</p>
									<p class="kome">重要なお知らせは、「郵送でのお知らせ」を選択していなくてもお届けすることがあります。</p>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<button id="next_button" class="button btn_center" type="button" value=""><span>次へ</span></button>
		</form>
	</div>
