		...
		<div class="wrap">
			...
			<div class="content_wrap">
				...
				<div class="bg_gray shiken">
					<p><span>試験名</span>CSCS認定試験</p>
					<p><span>受験料</span>49,330円</p>
				</div>
				<div class="kihon_joho">
					<h3>資格認定試験出願フォーム</h3>
					<p class="text">表示されている情報が最新でない場合は先に<a class="td_under" href="#">登録情報</a>より変更をお願いします。<br>
					...
					<form>
						<table>
							...
							<tr class="job">
								<th><span class="required">必須</span>職種<p class="sub sp_no">※複数選択可<br>※最大3つまで</p></th>
								<td>
									<p>※複数選択可<br>※最大3つまで</p>
									<div>
