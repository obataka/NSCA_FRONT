...
<head>
	...
	<link rel="stylesheet" href="../../viewIncludeFiles/css/ceuReport.css" />
	<link rel="stylesheet" href="../../viewIncludeFiles/css/header.css">

	<script type="text/javascript" src="../../viewIncludeFiles/js/jquery-3.1.1.min.js"></script>
	<script type="text/javascript" src="../../viewIncludeFiles/plugins/jQueryUI/jquery-ui.js"></script>
	<script type="text/javascript" src="../../viewIncludeFiles/plugins/jQueryUI/jquery.ui.datepicker-ja.js"></script>
	<script type="text/javascript" src="../../viewIncludeFiles/js/ceuReport.js"></script>
...
<body>
	...
	<div class="wrap">
		<h2>CEU報告</h2>
		<form method="post" name="ceuReportForm" action="">
			<input type="hidden" id="chkCSCS" name="chkCSCS" value="">
			<input type="hidden" id="chkCPT" name="chkCPT" value="">
			<div class="content_wrap">
				<div class="spb_arrows spb_arrows_3ver">
					<ul class="nav nav-tabs step-anchor">
						<li class="active"><span><small>CEU報告</small></span></li>
						<li><span><small>CEU報告　確認</small></span></li>
						<li><span><small>決済方法選択</small></span></li>
					</ul>
				</div>
				<p class="h2_text">表示されている情報が最新でない場合は先に<a href="#">登録情報</a>より変更をお願いします。</p>
				<article>
					<h3>登録情報</h3>
					<div class="form_wrap">
				...
				<article>
					...
					<table class="ceu_1">
						...
						<tbody>
							<tr>
								<td>必要CEU（①）</td>
								<td data-label="CSCS" id="cscs_hitsuyo"></td>
								<td data-label="NSCA-CPT" id="cpt_hitsuyo"></td>
								<td></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="ceu_2">
						<tbody>
							<tr>
								<td>カテゴリーA</td>
								<td data-label="CSCS" id="cscs_category_a"></td>
								<td data-label="NSCA-CPT" id="cpt_category_a"></td>
								<td data-label="取得ポイント" id="a_syutoku_p"></td>
							</tr>
							<tr>
								<td>カテゴリーB</td>
								<td data-label="CSCS" id="cscs_category_b"></td>
								<td data-label="NSCA-CPT" id="cpt_category_b"></td>
								<td data-label="取得ポイント" id="b_syutoku_p"></td>
							</tr>
							<tr>
								<td>カテゴリーC</td>
								<td data-label="CSCS" id="cscs_category_c"></td>
								<td data-label="NSCA-CPT" id="cpt_category_c"></td>
								<td data-label="取得ポイント" id="c_syutoku_p"></td>
							</tr>
							<tr>
								<td>カテゴリーD</td>
								<td data-label="CSCS" id="cscs_category_d"></td>
								<td data-label="NSCA-CPT" id="cpt_category_d"></td>
								<td data-label="取得ポイント" id="d_syutoku_p"></td>
							</tr>
							<tr>
								<td>現在取得CEU（②）</td>
								<td data-label="CSCS" id="cscs_genzai"></td>
								<td data-label="NSCA-CPT" id="cpt_genzai"></td>
								<td></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="ceu_3">
						<tbody>
							<tr>
								<td>残りCEU（①－②）</td>
								<td data-label="CSCS" id="cscs_zan"></td>
								<td data-label="NSCA-CPT" id="cpt_zan"></td>
								<td></td>
							</tr>
							<tr>
								<td>更新</td>
								<td data-label="CSCS">
									<input id="koushin_1" type="checkbox" name="koushin">
									<label class="checkbox" for="koushin_1"></label>
								</td>
								<td data-label="NSCA-CPT">
									<input id="koushin_2" type="checkbox" name="koushin">
									<label class="checkbox" for="koushin_2"></label>
								</td>
								<td></td>
							</tr>
						</tbody>
					...
					<div class="">
						<p>このCUE報告フォームの内容が私の継続教育単位取得のための活動を正確に記録したのもであることを確認しました。<br>
							また、現在有効なCPR・AEDの認定を保持していることを確約します。<br>
							継続教育単位のための活動を不正確に報告した場合、認定資格が失効になる可能性があることを承諾します。</p>
						<section class="doi">
							<input id="ceu_doi_1" type="radio" name="ceu_doi" value=""><label for="ceu_doi_1">同意する</label>
							<input id="ceu_doi_2" type="radio" name="ceu_doi" value=""><label for="ceu_doi_2">同意しない</label>
							<ul class="error_ul">
								<li class="error" id="err_doi_1"></li>
							</ul>
						</section>
					</div>
				</article>
				...
				<article>
					<div class="agreement_wrap">
						<h3>定款・規約・規程</h3>
						<p class="agreement_text">NSCA認定資格の更新手続きを行うにあたり、以下の「定款」「会員規約」「会員倫理規定」<br>
							「個人情報保護規定」「志願者および資格認定者の倫理規定・懲戒方針」の内容に必ず同意してください。
						</p>
						<div class="agreement">
							<div class="teikan">
							...
							<div class="kiyaku">
								<p class="title">特定非営利活動法人NSCAジャパン<br>
									志願者および資格認定者の倫理規定・懲戒方針
								</p>
								<dl>
									<dt></dt>
									<dd></dd>
							...
							<section class="doi">
								<input id="kuyaku_doi_1" type="radio" name="kuyaku_doi" value=""><label for="kuyaku_doi_1">同意する</label>
								<input id="kuyaku_doi_2" type="radio" name="kuyaku_doi" value=""><label for="kuyaku_doi_2">同意しない</label>
								<ul class="error_ul">
									<li class="error" id="err_doi_2"></li>
								</ul>
							</section>
						</div>
					</div>
				...
				<section>
					<button class="button btn_center" type="button" id="next" value="" onclick="location.href='#'"><span>次へ</span></button>
				</section>
			</div>
		</form>
	</div>
