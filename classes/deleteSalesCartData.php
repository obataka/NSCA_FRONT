...
if ($result == false) {
    ...
    if (!empty($meisai_exists)) {
        ...
        $soryo_keisan_1 = (new Tb_hambai_konyusha_joho_meisai())->soryoKeisan1($db, $param, $soryo_gokei, $param['buppan_soyo']);

        $soryo_keisan_2 = (new Tb_hambai_konyusha_joho_meisai())->soryoKeisan2($db, $param, $soryo_gokei, $param['buppan_soyo']);

        $gokei = $gokei + $soryo_gokei;
