...
SQL;
    ...
    * @return boolean
    */
    public function updateMemberSonota($db, $param2)
    {
        try {
            $sql = <<<SQL
...
SQL;
            ...
            $sth->execute([
                ...
                ':renraku_hoho_yuso'                    => $param2['renraku_hoho_yuso'],
                ':renraku_hoho_denshi_email'            => $param2['renraku_hoho_denshi_email'],
                ':email_1_merumaga_haishin'             => $param2['email_1_merumaga_haishin'],
                ':email_2_merumaga_haishin'             => $param2['email_2_merumaga_haishin'],
                ':email_1_oshirase_uketori'             => $param2['email_1_oshirase_uketori'],
                ':email_2_oshirase_uketori'             => $param2['email_2_oshirase_uketori'],
                ':yubin_haitatsusaki_kbn'               => $param2['yubin_haitatsusaki_kbn'],
                ':website_keisai_kbn'                   => $param2['website_keisai_kbn'],
                ':daisansha_questionnaire_kbn'          => $param2['daisansha_questionnaire_kbn'],
