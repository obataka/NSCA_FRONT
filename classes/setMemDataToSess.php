...
$_SESSION['kaihi'] = (!empty($_POST['kaihi'])) ? htmlentities($_POST['kaihi'], ENT_QUOTES, "UTF-8") : "";
...
$_SESSION['filepath_front'] = (!empty($_POST['filepath_front'])) ? htmlentities($_POST['filepath_front'], ENT_QUOTES, "UTF-8") : "";
$_SESSION['filepath_back'] = (!empty($_POST['filepath_back'])) ? htmlentities($_POST['filepath_back'], ENT_QUOTES, "UTF-8") : "";
...
$_SESSION['sel_mail_login'] = (!empty($_POST['sel_mail_login'])) ? htmlentities($_POST['sel_mail_login'], ENT_QUOTES, "UTF-8") : "";
$_SESSION['wk_sel_mail_login'] = (!empty($_POST['wk_sel_mail_login'])) ? htmlentities($_POST['wk_sel_mail_login'], ENT_QUOTES, "UTF-8") : "";
